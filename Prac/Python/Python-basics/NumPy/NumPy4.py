...
print("===== 1차원 배열 =====")
print("shape:", arr_1d.shape)  # (12,) // 각 차원의 크기
print("ndim:", arr_1d.ndim)  # 1 // 차원
print("size:", arr_1d.size)  # 12 // 전체 요소 개수
# ===== 1차원 배열 =====
# shape: (12,)
# ndim: 1
# size: 12
...
print(
    '''
2) 배열간 기본 산술 연산 (Element-wise Operations)
- NumPy는 같은 크기의 배열끼리 요소별(element-wise) 연산을 수행
...
# 순서를 바꿔도 작동 (교환법칙 성립)
print('스칼라 10 / 배열:', scalar / a)
# 스칼라 10 / 배열: [10. 5. 3.33333333 2.5 2.]
print()
...
- 첫번째 행렬의 열 개수와 두번째 행렬의 행 개수가 같아야 함
''')
...
b = np.array([[4], [5], [6]])
# 브로드캐스팅 과정
# 1. a의 shape을 (1, 3)으로 확장 [1, 2, 3] -> [[1, 2, 3]]
# 2. a(1, 3) + b(3, 1) 연산
# 3. 각 차원에서 브로드 캐스트:
#    - 첫 번째 차원: 1 -> 3으로 확장 [[1, 2, 3]] -> [[1, 2, 3],
#                                                  [1, 2, 3],
#                                                  [1, 2, 3]]
#    - 두 번째 차원: 3 <- 1로 확장 [[4],[5],[6]] -> [[4, 4, 4],
#                                                   [5, 5, 5],
#                                                   [6, 6, 6]]
# 4. 최종 결과 shape(3, 3)
print('a (3,):', a)
...
print('''
11) NumPy 배열 모양 변경과 조작 핵심 개념 요약
1. 배열 속성:
 - shape: 각 차원의 크기
  - ndim: 차원 수
  - size: 전체 요소 개수
